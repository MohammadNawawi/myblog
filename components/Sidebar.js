...
import { Dashboard } from "@heroicons/react/20/solid";
import React from "react";

const Sidebar = () => {
  return (
    <div className="h-screen px-4 pt-8 pb-4 flex text-center items-center justify-center w-40 border-dashed">
      <div>
        <div
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="cursor-pointer w-5 h-5 hover:fill-black fill-[#929292]"
          >
            <path
              fillRule="evenodd"
